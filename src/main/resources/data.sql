...
-- Insertar eventos
INSERT INTO evento (titulo, descripcion, fecha, localizacion_id, ciudad_id) VALUES
('Concierto de Música Renacentista', 'Concierto especial de música renacentista en la Sacra Capilla del Salvador', '2024-06-15', 3, 1),
('Visita Guiada Nocturna', 'Recorrido nocturno por los palacios renacentistas de Úbeda', '2024-06-20', 1, 1),
('Taller de Cerámica', 'Taller práctico de cerámica tradicional ubetense', '2024-06-25', 8, 1),
('Festival Gastronómico', 'Muestra de la gastronomía tradicional de Úbeda', '2024-07-01', 4, 1),
('Concierto de Órgano', 'Concierto de órgano en la Iglesia de San Pablo', '2024-07-05', 6, 1),
('Exposición de Arte', 'Exposición de arte contemporáneo en el Palacio Vázquez de Molina', '2024-07-10', 7, 1),
('Teatro Clásico', 'Representación de teatro clásico en el Hospital de Santiago', '2024-07-15', 4, 1),
('Visita a la Sinagoga', 'Visita guiada a la Sinagoga del Agua', '2024-07-20', 10, 1),
('Concierto de Música Sefardí', 'Concierto de música sefardí en el Palacio de las Cadenas', '2024-07-25', 2, 1),
('Festival de Música Antigua', 'Festival de música antigua en el Palacio del Deán Ortega', '2024-07-30', 5, 1);
